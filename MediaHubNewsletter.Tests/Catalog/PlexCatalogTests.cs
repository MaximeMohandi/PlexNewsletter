...
public class PlexCatalogTests
{
    ...
    public async Task ShouldFetchPlexCatalog()
    {
        var expected = new PlexMedia[]
        {
            new()
            {
                Title = "Sharknado", Type = MediaType.Movie, AddedAt = new DateTime(2024, 6, 10, 20, 42, 21),
                Summary =
            ...
            new()
            {
                ...
                AddedAt = new DateTime(2024, 6, 8, 16, 53, 59),
                Summary =
            ...
            new()
            {
                Title = "Inflation", Type = MediaType.TvShow, AddedAt = new DateTime(2024, 6, 15, 9, 40, 24),
                Summary = "",
                TvShow = "My Hero Academia", Season = 7, Episode = 7
            },
            new()
            {
                Title = "To Thine Own Self", Type = MediaType.TvShow, AddedAt = new DateTime(2024, 6, 14, 17, 26, 43),
                Summary =
