...
public class DiscordMessageWriterTests
{
    ...
    public void ShouldWriteIntoDiscordEmbedMessage()
    {
        var expected = new DiscordMessage(new[]
        {
            ...
            {
                new DiscordEmbedField("**Ring Fit Adventure** - S01E01", "Un voleur qui s'infiltre dans les rêves de ses cibles pour voler leurs secrets les plus précieux."),
                new DiscordEmbedField("**The Mandalorian** - S01E02-04", "A Mandalorian bounty hunter tracks a target for a well-paying client."),
                new DiscordEmbedField("**The Mandalorian** - S02E03", "The battered Mandalorian returns to his client for his reward."),
            })
        });
        ...
        var result = DiscordMessageWriter.Write(new[]
        {
            ...
            new FakeMedia()
            {
                ...
                Summary = "Un voleur qui s'infiltre dans les rêves de ses cibles pour voler leurs secrets les plus précieux.",
